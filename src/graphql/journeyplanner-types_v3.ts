...
export type InputBanned = {
  ...
  lines?: Maybe<Array<Maybe<Scalars['ID']>>>;
  /** Set of ids for authorities that should not be used */
  authorities?: Maybe<Array<Maybe<Scalars['ID']>>>;
...
export type ItineraryFilters = {
  ...
  groupSimilarityKeepOne?: Maybe<Scalars['Float']>;
  ...
  groupSimilarityKeepThree?: Maybe<Scalars['Float']>;
  ...
  groupedOtherThanSameLegsMaxCostMultiplier?: Maybe<Scalars['Float']>;
};
...
export type Modes = {
  ...
  transportModes?: Maybe<Array<Maybe<TransportModes>>>;
};
...
export type QuayEstimatedCallsArgs = {
  ...
  arrivalDeparture?: Maybe<ArrivalDeparture>;
  whiteListed?: Maybe<InputWhiteListed>;
  whiteListedModes?: Maybe<Array<Maybe<TransportMode>>>;
...
export type QueryTypeTripArgs = {
  ...
  bicycleOptimisationMethod?: Maybe<BicycleOptimisationMethod>;
  triangleFactors?: Maybe<TriangleFactors>;
  ...
  boardSlackList?: Maybe<Array<Maybe<TransportModeSlack>>>;
  alightSlackDefault?: Maybe<Scalars['Int']>;
  alightSlackList?: Maybe<Array<Maybe<TransportModeSlack>>>;
...
export type QueryTypeNearestArgs = {
  ...
  filterByModes?: Maybe<Array<Maybe<TransportMode>>>;
  filterByInUse?: Maybe<Scalars['Boolean']>;
  filterByIds?: Maybe<InputPlaceIds>;
  multiModalMode?: Maybe<MultiModalMode>;
  before?: Maybe<Scalars['String']>;
  after?: Maybe<Scalars['String']>;
  first?: Maybe<Scalars['Int']>;
...
export type QueryTypeLinesArgs = {
  ...
  flexibleOnly?: Maybe<Scalars['Boolean']>;
};
...
export type TransportModes = {
  ...
  transportSubModes?: Maybe<Array<Maybe<TransportSubmode>>>;
};
