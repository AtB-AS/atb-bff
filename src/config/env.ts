...
export const BONUS_INVITE_KEY_A: string | undefined = process.env.BONUS_INVITE_KEY_A;
export const BONUS_INVITE_KEY_B: string | undefined = process.env.BONUS_INVITE_KEY_B; 
