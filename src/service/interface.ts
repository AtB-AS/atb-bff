...
import { EstimatedCallFieldsFragment } from './impl/service-journey/journey-gql/jp3/service-journey-departures.graphql-gen';
...
export interface IServiceJourneyService_v2 {
  ...
  getDeparturesForServiceJourneyV2(
    id: string,
    query: DeparturesForServiceJourneyQuery
  ): Promise<Result<EstimatedCallFieldsFragment[] | null, APIError>>;
}
